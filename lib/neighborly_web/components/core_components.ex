defmodule NeighborlyWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: NeighborlyWeb.Gettext
  ...
  def simple_form(assigns) do
    ...
    <.form :let={f} for={@for} as={@as} {@rest}>
      <div class="p-4 mt-10 space-y-8 bg-white rounded-lg">
    ...
    <div class="overflow-y-auto md:overflow-visible">
      <table class="w-full">
        <thead class="text-sm leading-6 text-left text-zinc-500">
          <tr>
            <th :for={col <- @col} class="p-1 font-normal">{col[:label]}</th>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NeighborlyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NeighborlyWeb.Gettext, "errors", msg, opts)
    end
  end
